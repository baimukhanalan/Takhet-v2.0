...
export class AdminController {
  ...
  reversePayout(@Req() req: any, @Param('id') id: string, @Body() dto: ReversePayoutDto) {
    return this.paymentsService.reversePayout(id, req.user.id, dto.reason);
  }
}
