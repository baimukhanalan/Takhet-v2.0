...
export const serviceCatalog: ServiceDetail[] = [
  {
    ...
    title: {
      ru: 'Заказ лекарств',
      kz: 'Дәрі-дәрмек тапсырысы',
      en: 'Medicine ordering',
    },
    short: {
      ru: 'Помогает быстро оформить запрос на нужные лекарства без лишних звонков и уточнений.',
      kz: 'Қажетті дәрілерге сұранысты артық қоңыраусыз және нақтылаусыз жылдам рәсімдеуге көмектеседі.',
    ...
    what: {
      ...
      kz: 'Бұл дәріге сұранысты ыңғайлы жіберіп, келесі қадамды түсінікті түрде алғысы келетін пациенттерге арналған сервис.',
    ...
    why: {
      ...
      kz: 'Ол пациенттің уақытын үнемдеу, өтінімдердегі шатасуды азайту және дәріні алу процесін түсініктірек ету үшін қажет.',
    ...
    forWho: [
      {
        ...
        kz: 'Дәрігер тағайындаған препараттар қажет пациенттерге.',
        en: 'For patients who need medicines prescribed by a doctor.',
      },
      {
        ru: 'Для семей, которые хотят оформить запрос заранее и без спешки.',
        kz: 'Өтінімді алдын ала және асықпай рәсімдегісі келетін отбасыларға.',
      ...
      },
      {
        ...
        kz: 'Қолжетімділік пен келесі қадамдар туралы түсінікті байланыс маңызды адамдарға.',
    ...
    note: {
      ...
      kz: 'Қазір команда сервистің тұрақты жұмыс істеуі үшін логистика мен операциялық процестерді реттеп жатыр.',
  ...
  },
  {
    ...
    title: {
      ...
      kz: 'Үйге дәрігер шақыру',
      en: 'Doctor home visit',
    },
    short: {
      ru: 'Позволяет пациенту запросить очный выезд врача, когда ехать в клинику неудобно или тяжело.',
      kz: 'Клиникаға бару қиын немесе ыңғайсыз болғанда пациентке дәрігердің үйге келуін сұратуға мүмкіндік береді.',
    ...
    what: {
      ...
      kz: 'Бұл пациент тұрған жерде алғашқы қарауды өткізу ыңғайлы болған жағдайда дәрігердің үйге бару сервисі.',
    ...
    why: {
      ...
      kz: 'Ол қозғалысы шектеулі, жүктемесі жоғары немесе клиникаға баруы қиындаған адамдарға көмектесу үшін қажет.',
    ...
    forWho: [
      {
        ...
        kz: 'Клиникаға өздігінен жетуі қиын пациенттерге.',
      ...
      },
      {
        ...
        kz: 'Балалары немесе егде туыстары бар отбасыларға, қаралу үрдісін тыныш жағдайда өткізгісі келетіндерге.',
      ...
      },
      {
        ...
        kz: 'Емнің келесі кезеңіне дейін жағдайды сол жерде бағалау маңызды болғанда.',
    ...
    note: {
      ...
      kz: 'Команда шығу логистикасы мен маршруттауды қалпына келтіріп жатқанша бөлім уақытша тоқтатылған.',
