...
import { 
  ...
  Star, Clock, BarChart3, GraduationCap, Zap, Headphones, ShieldCheck, Globe, CheckCircle2,
  Video, FileText, ClipboardList, Sparkles, Layout, Wallet
} from 'lucide-react';
...
const B2BMatrix = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-0 rounded-[5rem] bg-primary/10 blur-[120px] animate-pulse"></div>
        {[...Array(4)].map((_, i) => (
          <div 
            key={i} 
...
const PartnersPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-primary selection:text-white overflow-x-hidden">
      ...
      <section className="relative pt-32 md:pt-48 pb-24 px-6 md:px-20 overflow-hidden bg-white">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
          <div className="flex-1 space-y-10 text-center lg:text-left animate-in fade-in slide-in-from-left duration-1000 ease-out">
            ...
            <button 
              onClick={handleCTA} 
              className="group w-full sm:w-auto px-10 md:px-12 py-5 md:py-6 bg-primary text-white rounded-[2rem] md:rounded-[2.5rem] font-black text-sm uppercase tracking-widest shadow-2xl shadow-primary/30 hover:shadow-primary/50 hover:scale-105 active:scale-95 transition-all duration-300 flex items-center justify-center gap-3 mx-auto lg:mx-0"
            >
              Индивидуальные условия
              <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </button>
          </div>
          <div className="flex-1 w-full animate-in fade-in zoom-in duration-1000 delay-200">
            <B2BMatrix />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-12">
          {[
            ...
            <div key={i} className="text-center space-y-4 group">
              <div className="w-12 h-12 md:w-14 md:h-14 bg-white rounded-xl md:rounded-2xl flex items-center justify-center mx-auto shadow-sm text-primary mb-4 group-hover:scale-110 group-hover:bg-primary group-hover:text-white transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto space-y-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            {[
              ...
              <div key={i} className="bg-white p-10 md:p-12 rounded-[3rem] md:rounded-[4rem] border border-slate-100 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group">
          ...
          <div className="bg-slate-900 p-8 md:p-20 rounded-[3rem] md:rounded-[5rem] text-white relative overflow-hidden group">
             <div className="relative z-10 space-y-8 max-w-3xl">
                ...
                <button onClick={handleCTA} className="px-10 md:px-12 py-5 md:py-6 bg-primary text-white rounded-[2rem] font-black uppercase text-[10px] md:text-xs tracking-widest shadow-2xl hover:bg-blue-600 transition-all">Оставить заявку</button>
             </div>
        ...
        <div className="max-w-7xl mx-auto space-y-20 px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <div key={i} className="flex flex-col md:flex-row gap-8 p-10 md:p-12 bg-white rounded-[3rem] md:rounded-[4rem] border border-slate-100 hover:shadow-2xl hover:border-primary/20 transition-all group">
                <div className="w-14 h-14 md:w-16 md:h-16 bg-slate-50 rounded-[1.5rem] md:rounded-[2rem] flex items-center justify-center shrink-0 shadow-inner text-primary group-hover:bg-primary group-hover:text-white transition-all duration-500 mx-auto md:mx-0">
        ...
        <div className="max-w-7xl mx-auto space-y-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative px-4">
            ...
            {[
              ...
              <div key={i} className="relative p-10 md:p-12 bg-white border border-slate-100 rounded-[3rem] md:rounded-[3.5rem] text-center shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group">
                <div className="w-16 h-16 md:w-20 md:h-20 bg-primary text-white rounded-full flex items-center justify-center font-black text-2xl md:text-3xl mx-auto mb-10 border-4 md:border-8 border-white shadow-2xl transition-transform group-hover:scale-110 group-hover:rotate-12">{s.id}</div>
          ...
          <div className="text-center pt-10 px-6">
             <button onClick={handleCTA} className="group w-full sm:w-auto px-8 md:px-16 py-6 md:py-8 bg-slate-900 text-white rounded-[2rem] md:rounded-[2.5rem] font-black text-base md:text-xl uppercase tracking-widest shadow-2xl hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-3 mx-auto">
      ...
      {/* 6. Bottom Branding */}
      <div className="py-24 bg-white text-center px-6 border-t border-slate-50">
