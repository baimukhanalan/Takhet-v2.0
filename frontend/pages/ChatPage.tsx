            ...
            <div className="p-6 border-b border-border flex items-center justify-between bg-slate-50/50">
              ...
              <div className="flex items-center gap-3">
                ...
                {user.role === UserRole.DOCTOR && !activeChat.consultationEndDate && (
                  <button onClick={handleFinish} className="flex items-center gap-2 px-5 py-2.5 bg-success text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-green-700 transition-colors shadow-lg shadow-success/20">
